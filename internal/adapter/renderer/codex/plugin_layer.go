...
// renderPlugins generates .codex-plugin/ packaging for inline plugins
// and emits MCP reference entries for external plugins. Plugins with
// distribution mode "inline" have their artifacts copied into the output.
// Plugins with "external" distribution emit only configuration references.
// Registry plugins emit install metadata entries.
func renderPlugins(
