...
// renderSkills generates .claude/skills/{id}/SKILL.md files in AgentSkills.io format.
...
func renderSkills(
	...
	for _, skill := range skills {
		...
		skillDir := fmt.Sprintf(".claude/skills/%s", skillID)

		var content strings.Builder

		// Generate AgentSkills.io YAML frontmatter.
		content.WriteString("---\n")
		...
		// Model preference (Claude-specific).
		...
		// Emit sidecar assets for references, assets, and scripts.
...
// getFieldString extracts a string field from Fields or the object's description.
